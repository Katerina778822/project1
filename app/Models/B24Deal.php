...
class B24Deal extends Model
{
    ...
    protected $fillable = [
        ...
        'UF_CRM_1545811274193', 'UF_CRM_1547732437301', 'DATE_CREATE', 'CLOSEDATE', 'UF_CRM_5C224D08961A9', 'DATE_MODIFY','dealtype_id','deal_id','id1','branch_id '
    ];
    ...
    {
        return  $this->belongsTo(dealType::class, 'dealtype_id')->first();
    }
